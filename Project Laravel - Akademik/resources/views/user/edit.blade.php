                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="number" class="form-control" name="nip" id="nip" value="{{$users->nip}}" placeholder="NIP ..." required>   
                            </div>
                            <div class="form-group">
                                <label>Nama Lengkap</label>
                                <input type="text" class="form-control" name="name" id="name" value="{{$users->name}}" placeholder="Nama Lengkap ..." required>   
                            </div>
                            <div class="form-group">
                                <label>No Handphone</label>
                                <input type="number" class="form-control" name="nohp" id="nohp" value="{{$users->nohp}}" placeholder="No Handphone ..." required>   
                            </div>
                            ...
                            <div class="form-group">
                                <img  id="modal-preview" src="/image/user{{$users->foto}}" alt="preview" class="form-group hidden" width="100" height="100">
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="jenkel" id="jenkel" required>
                                    <option value="{{$users->jenkel}}" hidden>{{$users->jenkel}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="password" id="password" value="{{$users->password}}" placeholder="Password ..." required>   
                            </div>
                            <div class="form-group">
                                <label>Role</label>
