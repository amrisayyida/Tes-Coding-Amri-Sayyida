            ...
            <div id="sidebar">
                <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            <li class="sidebar-item @if(isset($active_home))
                            {{ $active_home }}
                            @endif">
                            ...
                            <li class="sidebar-item @if(isset($active_master))
                            {{ $active_master }}
                            @endif has-sub">
                                ...
                                <ul class="submenu @if(isset($active_sub))
                            {{ $active_sub }}
                            @endif">
                            ...
                            @endif has-sub">
                                ...
                                <ul class="submenu @if(isset($active_sub_siswa))
                            {{ $active_sub_siswa }}
                            @endif">
                                    <li class="submenu-item">
                                        <a
                            ...
                            <li class="sidebar-item @if(isset($active_guru))
                            {{ $active_guru }}
                            @endif has-sub">
                                <a href="/user" class="sidebar-link">
                                    <i class="bi bi-stack"></i>
                                ...
                                <ul class="submenu @if(isset($active_sub_guru))
                            {{ $active_sub_guru }}
                            @endif">
                                    <li class="submenu-item">
                                        <a
