...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/login_assets/css/my-login.css">
...
<body class="my-login-page">
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img src="/login_assets/img/logo.jpg" alt="logo">
					</div>
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Login Admin / Guru</h4>
					...
					<div class="footer">
						Copyright &copy; 2025 &mdash; SDN BUMIREJO
					</div>
				</div>
			</div>
		</div>
	...
	<script src="/login_assets/js/my-login.js"></script>
